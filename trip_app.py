...
st.number_input("Días de viaje", min_value=1, key="dias") st.number_input("Hospedaje por día ($)", min_value=0.0, key="hospedaje") st.number_input("Alimentación por día ($)", min_value=0.0, key="alimentacion") st.number_input("Transporte total ($)", min_value=0.0, key="transporte") st.number_input("Número de personas", min_value=1, key="personas")
...
if st.button("Reiniciar formulario"): st.session_state.dias = 1 st.session_state.hospedaje = 0.0 st.session_state.alimentacion = 0.0 st.session_state.transporte = 0.0 st.session_state.personas = 1 st.experimental_rerun()
